...
this["FlickrAssistantTemplates"]["faved-authors-list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                <a href=\"https://www.flickr.com/photos/"
    ...
    + "\" target=\"_blank\" title=\""
    + alias2((helpers.attr || (depth0 && depth0.attr) || helpers.helperMissing).call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.photo : depth0)) != null ? stack1.title : stack1),{"name":"attr","hash":{},"data":data}))
    + " ("
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.photo : depth0)) != null ? stack1.count_faves : stack1), depth0))
    + ")\"><img src=\""
...
this["FlickrAssistantTemplates"]["top-faved-authors"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<h2>Faved authors\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.nonContacts : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
